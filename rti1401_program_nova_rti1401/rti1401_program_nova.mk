...
#
#  $RCSfile: rti1401_program_nova.mk $ $Revision: 2.95 $ $Date: 2016/03/14 14:26:10MEZ $
...
MAKEFILE                       = rti1401_program_nova.mk
...
COMPUTER                       = PCWIN64
MODEL                          = rti1401_program_nova
MODULES                        = rtGetInf.c rtGetNaN.c rt_nonfinite.c rti1401_program_nova_data.c rti1401_program_nova_trc_ptr.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 3
...
RTWCUST_INCLUDES = \
	...
	"$(START_DIR)\rti1401_program_nova_rti1401" \
	"$(START_DIR)"
...
TMP_PATH_CC += "E:\Programs\DSPACE~2\MATLAB\RTICAN\TLC"
