# =============================================================================
#  FILE:
#    Torque_Vectoring_Controller_dSpace_RTI1401.mk
#
#  DESCRIPTION:
...
#
#  $RCSfile: Torque_Vectoring_Controller_dSpace_RTI1401.mk $ $Revision: 2.95 $ $Date: 2016/03/14 14:26:10MEZ $
...
MAKEFILE                       = Torque_Vectoring_Controller_dSpace_RTI1401.mk
...
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2016a
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2016a\bin
RELEASE_VERSION                = R2016a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = Torque_Vectoring_Controller_dSpace_RTI1401
MODULES                        = Torque_Vectoring_Controller_dSpace_RTI1401_data.c Torque_Vectoring_Controller_dSpace_RTI1401_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 1
...
MASTER_ANCHOR_DIR              = 
START_DIR                      = E:\Dropbox\Uni\FEBTV~1\Simulink\FS_GEN~1\SRC_CM~2
# Shared library for utility code
RTW_SHARED_LIB_SRCS_WILD       = 
RTW_SHARED_LIB_SRCS_DIR        = 
RTW_SHARED_LIB_OBJS_DIR        = 
RTW_SHARED_LIB                 = 
RTW_MODELLIB                   = Torque_Vectoring_Controller_dSpace_RTI1401lib.lib
...
RTWCUST_INCLUDES = \
	...
	"$(START_DIR)\Torque_Vectoring_Controller_dSpace_RTI1401_rti1401" \
	"$(START_DIR)"
