/*********************** dSPACE target specific file *************************
   ...
   Include file Torque_Vectoring_Controller_dSpace_RTI1401_rti.c:
...
#define RTB_STRUCTURE_NAME             Torque_Vectoring_Controller_d_B
#define RTP_STRUCTURE_NAME             Torque_Vectoring_Controller_d_P
